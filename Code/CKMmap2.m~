...
samp = 10; c = NoPts / 2; L = 10; thresh = 0;
distance = []; defocus = [];


[ref, ref180] = CPMpsf(XYrange, NoPts, R, 0);

% ref = ref(c-L:c+L, c-L:c+L);
% ref180 = ref180(c-L:c+L, c-L:c+L);
% ref = imresize(ref, samp);
% ref180 = imresize(ref180, samp);
% figure; imshow(ref, [])
%------------------------------------------------------------%
...
%     psf = psf(c-L:c+L, c-L:c+L);
%     psf180 = psf180(c-L:c+L, c-L:c+L);
%     psf = imresize(psf, samp);
%     psf180 = imresize(psf180, samp);
...
save('../CKM/CKMdata/CKMfitLinNOSQRT.mat', 'CKMfit')
